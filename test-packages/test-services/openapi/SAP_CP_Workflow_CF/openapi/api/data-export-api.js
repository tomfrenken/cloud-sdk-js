...
exports.DataExportApi = exports.DataExportApiFactory = exports.DataExportApiFp = exports.DataExportApiAxiosParamCreator = void 0;
 ...
 * @export
 */
var DataExportApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
...
exports.DataExportApiAxiosParamCreator = DataExportApiAxiosParamCreator;
/**
 * DataExportApi - functional programming interface
 * @export
 */
var DataExportApiFp = function (configuration) {
    return {
        /**
         * Requests the export of workflow definitions metadata, form definitions metadata, workflow instances, and task instances. The file and data structures used are subject to change.  Roles permitted to execute this operation:  - Global roles:  WorkflowTenantOperator  - Scope: DATA_EXPORT
         * @summary Data Export
...
exports.DataExportApiFp = DataExportApiFp;
/**
 * DataExportApi - factory interface
 * @export
 */
var DataExportApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         * Requests the export of workflow definitions metadata, form definitions metadata, workflow instances, and task instances. The file and data structures used are subject to change.  Roles permitted to execute this operation:  - Global roles:  WorkflowTenantOperator  - Scope: DATA_EXPORT
         * @summary Data Export
...
exports.DataExportApiFactory = DataExportApiFactory;
/**
 ...
 * @extends {BaseAPI}
 */
var DataExportApi = /** @class */ (function (_super) {
    __extends(DataExportApi, _super);
    function DataExportApi() {
...
exports.DataExportApi = DataExportApi;
